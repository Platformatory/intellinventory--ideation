...
> **Relevant context**: [`ideation/problem-statement-and-architecture-proposal.md`](../problem-statement-and-architecture-proposal.md)
...
# `Eng` (Engine)
- V1: [`engine-architecture-v1.md`](./engine-architecture-v1.md)
